		...
		<main className='min-h-screen bg-white'>
			...
			<div className='bg-black text-white py-20 lg:py-32 relative overflow-hidden'>
				...
				<div className='container mx-auto px-6 relative z-10 text-center'>
					<span className='text-primary-red font-bold tracking-widest uppercase text-sm mb-4 block animate-fade-in'>
						Stay Informed
					</span>
				...
				{/* Decorative elements */}
				<div className='absolute -bottom-24 -left-24 w-96 h-96 bg-primary-red/10 rounded-full blur-3xl pointer-events-none' />
				<div className='absolute top-0 right-0 w-64 h-64 bg-primary-red/5 rounded-full blur-3xl pointer-events-none' />
			</div>
