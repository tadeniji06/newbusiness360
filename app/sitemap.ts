...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
	...
	const blogEntries: MetadataRoute.Sitemap = blogPosts.map(
		(post: any) => ({
			url: `https://www.thisisbusiness360.com/posts/${post.slug.current}`,
	...
	const staticPages: MetadataRoute.Sitemap = [
		...
		{
			url: "https://www.thisisbusiness360.com/about",
			lastModified: new Date(),
			changeFrequency: "monthly",
			priority: 0.8,
		},
		{
			url: "https://www.thisisbusiness360.com/reports",
			lastModified: new Date(),
			changeFrequency: "monthly",
			priority: 0.8,
		},
		...
		{
			url: "https://www.thisisbusiness360.com/posts",
			lastModified: new Date(),
