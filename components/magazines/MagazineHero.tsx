				...
				<div className='p-6 flex flex-col gap-4'>
					...
					{!allowed ? (
						<button
							...
							className='w-full bg-black text-white px-6 py-3 rounded-lg font-medium shadow-sm hover:bg-red-600 transition'
						>
...
const MagazineHero = () => {
	const magazines: Magazine[] = [
		...
		// },
		{
			...
			month: "January",
			year: "2026",
			driveFileId: "1BAnSOe-fUWqK7JUy5-7XOrTsNOUXHd4W",
			imageSrc: a1,
		},
		// {
