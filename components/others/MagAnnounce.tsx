			...
			{open && (
				...
				>
					...
					<button
						...
						className='absolute top-2 right-2 text-gray-600 hover:text-blue-500 text-lg'
					>
						✕
					</button>
					...
					<p className='text-sm text-gray-700 leading-snug'>
						Your October edition is now live. Tap in to explore the
						latest stories.
					</p>
					...
					<Link
						href='/magazines'
						onClick={() => setOpen(false)}
						className='bg-primary-red text-white text-center py-2 rounded-lg text-sm font-medium hover:bg-blue-700 transition'
					>
						Check it Out
					</Link>
				</motion.div>
