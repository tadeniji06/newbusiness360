...
const Header = () => {
	...
	const [openDropdown, setOpenDropdown] = useState<string | null>(
		null,
	); // currently open dropdown title or null
		...
		>
			<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
				<nav className='flex items-center justify-between md:h-[120px] h-24'>
					...
					<Link href={"/"}>
						<Image
							className='md:h-[90px] md:w-[200px] h-[70px] w-[150px] object-contain'
							width={150}
							alt='logo'
							src={logo}
						/>
					...
					<div className='hidden md:flex items-center gap-3 lg:gap-4'>
						...
						<Link
							...
							href={"/contact"}
						>
							<button className='cursor-pointer bg-primary-red text-white rounded-lg shadow-md px-3 py-2 lg:px-5 lg:py-3 text-sm lg:text-base font-medium hover:bg-blue-800 transition-colors duration-200'>
								Get In Touch
							</button>
						</Link>
					</div>
